 ...
 *Name: Moly Arwood
 *Date: 7-18-16
 *Description: MedusaBoss.cpp is a class implementation file for subclass
 MedusaBoss 
 ************************************************************************/
 ...
 ************************************************************************/
 ...
 /*************************************************************************
 *Function: Defense
 *Description: if other MedusaBoss does not turn you to stone, roll the 
 specified defense dice and apply any damage to strength
 *Parameters: int attackRoll
 *Pre-Condition: None
 *Post-Condition: 
 ************************************************************************/
double MedusaBoss::defense(double aRoll) {

	if (aRoll == 550) {
		strength = -1;
		cout << "Boss made an undeniable argument. Game Over" << endl;
	}
	else {
